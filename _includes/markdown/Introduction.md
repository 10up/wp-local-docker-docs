[WP Local Docker](https://github.com/10up/wp-local-docker-v2) is an easy to use Docker based local development environment for WordPress development that works on Mac,
